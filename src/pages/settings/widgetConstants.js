import { SiFacebook, SiInstagram, SiGithub, SiDiscord, SiYoutube } from 'react-icons/si';
...
export const WIDGET_PLATFORMS = [
  ...
  },
  {
    ...
    extraOptionKey: 'secondStyle',
    extraOptionLabel: 'สไตล์ที่ 2',
    extraOptionDesc: 'สลับไปใช้เลย์เอาต์การ์ดแบบทางเลือก',
  },
  {
    id: 'discord',
    label: 'Discord',
